...
def build_summary_message(
    *,
    ...
    if grade_count > 0 and team_count > 0:
        return (
            "Grade와 팀 최소 인원 요구가 동시에 빠듯하여 모두 충족하지는 못했지만, "
            "가능한 범위에서 최적의 근무표를 생성했습니다."
        )
    if grade_count > 0:
        return (
            "입력하신 Grade 최소 인원 요구가 가용 간호사 대비 빠듯하여, "
            "가능한 범위에서 최적의 근무표를 생성했습니다."
        )
    if team_count > 0:
        return (
            "입력하신 팀별 최소 인원 요구가 가용 인원 대비 빠듯하여, "
            "가능한 범위에서 최적의 근무표를 생성했습니다."
        )
    if coverage_count > 0:
        return (
    ...
    return (
        "입력 제약이 빠듯하여 일부 제약을 완화하고 가능한 범위에서 최적의 근무표를 생성했습니다."
    )
