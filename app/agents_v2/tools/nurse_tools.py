    ...
    *,
    ...
    if _new_allowed is not None:
        ...
        if _allowed:  # 빈=제한없음 → skip
            ...
            for _lim in db.query(NurseMonthlyLimit).filter(NurseMonthlyLimit.nurse_id == nurse.nurse_id).all():
