...
async def get_nurses_in_group(
    ...
    # print('[nurses.py - get_nurses_in_group] office_id', office_id)
    # print('[nurses.py - get_nurses_in_group] group_id', group_id)
    # print('[nurses.py - get_nurses_in_group] current_user', current_user.__dict__)
    # if current_user.is_master_admin:
    #     target_group_id = group_id
    # else:
    #     target_group_id = current_user.group_id
    # print('[nurses.py - get_nurses_in_group] target_group_id', target_group_id)
    # print('[nurses.py - get_nurses_in_group] current_user.is_master_admin', current_user.is_master_admin)
    try:
